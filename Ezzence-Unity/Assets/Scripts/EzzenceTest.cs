...
using System.Linq;
using System.Text;
public class EzzenceTest : MonoBehaviour
{
    public string DeviceName = "Ezzence";
    public string ServiceUUID = "6E400001-B5A3-F393-­E0A9-­E50E24DCCA9E";
    public string TXUUID ="6E400002-B5A3-F393-­E0A9-­E50E24DCCA9E"; //TX - Write
    public string RXUUID = "6E400003-B5A3-F393-­E0A9-­E50E24DCCA9E"; //RX - Read
    ...
    private string StatusMessage
    {
        set
        {
            ...
            ButtonPositionText.text = "Waiting...";
    ...
    {
        /*ButtonPositionText.text =  System.Text.Encoding.UTF8.GetString(bytes);
        /*if (bytes[0] == null)
            ButtonPositionText.text = "Nothing sent";
        else
            ButtonPositionText.text = "Something is sending";*/
    }
            ...
            if (_timeout <= 0f)
            {
                ...
                switch (_state)
                {
                    ...
                    case States.Connect:
                        ...
                        BluetoothLEHardwareInterface.ConnectToPeripheral(_deviceAddress, null, null, (address, serviceUUID, characteristicUUID) =>
                        {
                            ...
                            if (IsEqual(serviceUUID, ServiceUUID))
                            {
                                ...
                                if (_foundRXUUID && _foundTXUUID)
                                {
                                    _connected = true;
                                    SetState(States.Subscribe, 2f);
                                }
                            }else{
                                StatusMessage = "Not found Service UUID";
                            }
                        });
                        break;
                    ...
                    case States.Subscribe:
                        ...
                        BluetoothLEHardwareInterface.SubscribeCharacteristicWithDeviceAddress(_deviceAddress, ServiceUUID, RXUUID, (notifyAddress, notifyCharacteristic) =>
                        {
                            StatusMessage = "Waiting for user action (1)...";
                            _state = States.None;

                            // read the initial state of the button
                            BluetoothLEHardwareInterface.ReadCharacteristic(_deviceAddress, ServiceUUID, RXUUID, (characteristic, bytes) =>
                            {
                                ProcessButton(bytes);
                            });
                    ...
                    case States.Unsubscribe:
                        BluetoothLEHardwareInterface.UnSubscribeCharacteristic(_deviceAddress, ServiceUUID, RXUUID, null);
...
//Added judith
    void SendString(string value)
	{
		...
		BluetoothLEHardwareInterface.WriteCharacteristic (_deviceAddress, ServiceUUID, TXUUID, data, data.Length, true, (characteristicUUID) => 
        {
    ...
    string FullUUID(string uuid)
    {
        ...
        if (fullUUID.Length == 4)
            fullUUID = "0001" + uuid + "-B5A3-F393-­E0A9-­E50E24DCCA9E";
